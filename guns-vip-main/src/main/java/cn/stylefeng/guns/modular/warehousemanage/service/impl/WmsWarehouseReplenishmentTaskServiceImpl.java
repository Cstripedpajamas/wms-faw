...
public class WmsWarehouseReplenishmentTaskServiceImpl extends ServiceImpl<WmsWarehouseReplenishmentTaskMapper, WmsWarehouseReplenishmentTask> implements WmsWarehouseReplenishmentTaskService {
    ...
    public void stopTask() {
        this.baseMapper.stopTask();
    }

    @Override
    public LayuiPageInfo findList(WmsWarehouseReplenishmentTaskParam param) {
        Page pageContext = getPageContext();
        IPage page = this.baseMapper.findList(pageContext, param);
        return LayuiPageFactory.createPageInfo(page);
    }

    @Override
    public WmsWarehouseReplenishmentTaskResult inExecution() {
