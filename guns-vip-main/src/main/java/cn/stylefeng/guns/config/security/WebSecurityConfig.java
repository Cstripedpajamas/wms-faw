...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/oauth/claimCallbackComplete/*").permitAll()
                ...
                .antMatchers("/one-cabinet/*").permitAll()
                .antMatchers("/repair/*").permitAll()
                .antMatchers("/repair-give-back/*").permitAll()
                .antMatchers("/warehouse/*").permitAll()
                .antMatchers("/claim/*").permitAll()
                .antMatchers("/out-in/*").permitAll()
