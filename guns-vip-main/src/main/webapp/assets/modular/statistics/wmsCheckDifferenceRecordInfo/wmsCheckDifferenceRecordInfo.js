layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsCheckDifferenceRecordInfo.initColumn = function () {
        return [[
            ...
            {field: 'taskNumber', sort: true, title: '盘点任务'},
            {field: 'locaSerialNumber', sort: true, title: '库位信息'},
            {align: 'center', field: 'differenceType', templet: '#differenceTypeTpl', sort: true, title: '差异类型'},
