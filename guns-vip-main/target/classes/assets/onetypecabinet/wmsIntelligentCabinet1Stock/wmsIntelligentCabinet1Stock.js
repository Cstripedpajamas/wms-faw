layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsIntelligentCabinet1Stock.initColumn = function () {
        return [[
            ...
            {field: 'plant', sort: true, title: '工厂',minWidth: 120},
            {field: 'diBatchNo', sort: true, title: '批次号',minWidth: 120},
            {field: 'materialSerialNumber', sort: true, title: 'RFID编码',minWidth: 120},
            {field: 'mNumber', sort: true, title: '数量'},
            {field: 'toolState', sort: true, title: '非消耗品工具状态',templet: '#toolStateTpl'},
    ...
    WmsIntelligentCabinet1Stock.search = function () {
        var queryData = {};
        queryData['locaSerialNumber'] = $("#locaSerialNumber").val();
        ...
        queryData['toolState'] = $("#toolState1").val();
    ...
    */
    ...
    table.on('checkbox(wmsIntelligentCabinet1StockTable)',function (obj) {
