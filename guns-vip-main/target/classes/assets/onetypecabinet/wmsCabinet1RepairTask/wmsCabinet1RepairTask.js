layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsCabinet1RepairTask.initColumn = function () {
        return [[
            ...
            {field: 'type', sort: true, title: '物料类型',templet: '#type'},
            {field: 'sizes', sort: true, title: '规格型号'},
            {field: 'operator', sort: true, title: '操作人姓名'},
            {field: 'workTeam', sort: true, title: '组织编码'},
            {field: 'materialName', sort: true, title: '描述'},
            {field: 'materialSku', sort: true, title: '物料号'},
            // {field: 'materialSku', sort: true, title: '物料号'},
            // {field: 'materialId', sort: true, title: '物料信息ID'},
            {field: 'materialSerialNumber', sort: true, title: 'RFID编码', minWidth: 160},
    ...
    */
    ...
    table.on('checkbox(wmsCabinet1RepairTaskTable)',function (obj) {
