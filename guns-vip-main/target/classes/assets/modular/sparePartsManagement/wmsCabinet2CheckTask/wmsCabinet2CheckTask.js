layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsCabinet2CheckTask.initColumn = function () {
        return [[
            ...
            {align: 'center',field: 'userName', sort: true, title: '操作人员姓名'},
            {align: 'center',field: 'serialNumber', sort: true, title: '操作人员工号'},
    ...
    */
    ...
    table.on('checkbox(wmsCabinet2CheckTaskTable)',function (obj) {
