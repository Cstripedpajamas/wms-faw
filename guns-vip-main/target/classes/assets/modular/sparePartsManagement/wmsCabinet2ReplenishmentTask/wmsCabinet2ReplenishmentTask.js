layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsCabinet2ReplenishmentTask.initColumn = function () {
        return [[
            ...
            {field: 'userName', sort: true, title: '操作人员姓名'},
            {field: 'serialNumber', sort: true, title: '操作人员工号'},
            ...
            {align: 'center',field: 'turnoverNumber', sort: true, title: '条码信息'},
    ...
    */
    ...
    table.on('checkbox(wmsCabinet2ReplenishmentTaskTable)',function (obj) {
