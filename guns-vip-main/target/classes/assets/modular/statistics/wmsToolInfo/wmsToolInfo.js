layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsToolInfo.initColumn = function () {
        return [[
            ...
            {field: 'materialStateNew', sort: true, title: '新数量'},
            {field: 'materialStateUsing', sort: true, title: '使用数量'},
            {field: 'materialStateFix', sort: true, title: '维修数量'},
            {field: 'materialStateDis', sort: true, title: '报废数量'},
            {field: 'storageStateInit', sort: true, title: '初始存放'},
            {field: 'storageStateIn', sort: true, title: '库内存放'},
            {field: 'storageStateOut', sort: true, title: '库外存放'},
            {field: 'storageAddressAsRs', sort: true, title: '立库数量'},
            {field: 'storageAddressI', sort: true, title: 'I类柜数量'}
    ...
    table.on('checkbox(wmsToolInfoTable)',function (obj) {
