...
layui.use(['form', 'admin', 'ax'], function () {
    ...
    //获取详情信息，填充表单
    var ajax = new $ax(Feng.ctxPath + "/wmsToolInfo/detail?id=" + Feng.getUrlParam("id"));
    var result = ajax.start();
    form.val('wmsToolInfoForm', result.data);

    //表单提交事件
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/wmsToolInfo/editItem", function (data) {
            Feng.success("更新成功！");
