layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsWarehouseToolUseTask.initColumn = function () {
        return [[
            ...
            {field: 'barCode', sort: true, title: '周转箱编号'},
            {field: 'mNumber', sort: true, title: '数量',minWidth: 120},
            {field: 'sortingNum', sort: true, title: '分拣数量',minWidth: 120},
            {field: 'sortingType', sort: true, title: '分拣类型',templet: '#sortingInfoTpl'},
            ...
            {field: 'workTeam', sort: true, title: '所属组织'},
    ...
    */
    ...
    table.on('checkbox(wmsWarehouseToolUseTaskTable)',function (obj) {
