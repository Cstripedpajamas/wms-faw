layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    WmsWarehousePurchaseStorageTask.search = function () {
        ...
        queryData['taskState'] = $("#taskState").val();
    ...
    */
    ...
    table.on('checkbox(wmsWarehousePurchaseStorageTaskTable)',function (obj) {
